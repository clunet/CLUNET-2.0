...
**Bootloader готов к тестированию в папке demo_project/clunet_bootloader... Понимаю, что без инструментария, а именно адаптера ПК->CLUNET это весьма проблематично, поэтому именно его изготовлением и займусь в ближайшее время!**
