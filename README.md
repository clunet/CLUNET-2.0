...
## Особенности и принцип
 ...
 3. Алгоритм обеспечивает _**синхронизацию операций чтения и передачи по доминантному сигналу**_. Это обеспечивает превосходные результаты при чтении и арбитраже на шине при активном конкурентном использовании шины несколькими устройствами одновременно.
