...
**Bootloader готов к тестированию в папке _demo_project/clunet_bootloader_ Понимаю, что без инструментария, а именно адаптера ПК->CLUNET это весьма проблематично, поэтому его изготовлением на базе _Sparkfun Pro Micro 16MHz_ и займусь в ближайшее время.**
