...
## Схемотехника
Шина **CLUNET 2.0** использует для передачи и приема данных **всего один** провод и **одну ногу** микроконтроллера. Организовать и подключиться к ней возможно 2 способами:
